    ...
    return (
      <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ textAlign: 'center', maxWidth: 380, background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '40px 32px', boxShadow: '0 24px 60px rgba(0,0,0,0.5)' }}>
          ...
          <a href="/api/auth/discord?redirect=/admin" style={{ display: 'inline-flex', alignItems: 'center', gap: 9, background: '#5865F2', color: '#fff', textDecoration: 'none', borderRadius: 'var(--radius-sm)', padding: '11px 22px', fontSize: 14, fontWeight: 600 }}>
